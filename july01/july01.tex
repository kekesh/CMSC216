...
How does our assembly code become machine language? We use an \vocab{assembler} (which is analogous to a compiler), which produces the zeroes and ones associated with our instructions. 
